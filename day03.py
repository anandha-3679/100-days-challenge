...
print("Right/Left?")
ans = input("Type Right or Left:").lower()
...
if ans == "left":
  ...
  ''')
    ...
    /,'    ``--.._____\/--''
        ''')
        print("Unfortunately, A shark ate you, game over.")
    else:
        print("Nice choice, you made it to Treasure Island!")
        print("Welcome to:")
        print('''
     _                                     _     _                 _ 
    | |                                   (_)   | |               | |
    ...
    \__|_|  \___|\__,_|___/\__,_|_|  \___|_|___/_|\__,_|_| |_|\__,_|
        ...
        ans = input("Now that you've made it to Treasure Island, you can dig or search the cave. \n Type Dig/Cave: ").lower()
        if ans == "cave":
            print('''
      _                     
      | |                    
